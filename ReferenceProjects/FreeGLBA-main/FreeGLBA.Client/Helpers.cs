...
using FreeGLBA.Client.Pages.Settings.Tags;
// {{ModuleItemEnd:Tags}}
using FreeGLBA.Client.Pages.Settings.Users;
...
public static partial class Helpers
{
    ...
    public static async Task EditUser(Guid UserId, Delegate? OnSaved = null, string width = "auto", string height = "auto")
    {
        ...
        await DialogService.OpenAsync<FreeGLBA.Client.Pages.Settings.Users.EditUser>(title, parameters, new DialogOptions() {
