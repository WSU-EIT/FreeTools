# 🌐 Site Report: https://ro411.em.wsu.edu/

> **Status:** ⚠️ 0/1 pages OK  
> **Folder:** `ro411-em-wsu-edu/`  
...
```
Refused to apply style from 'https://ro411.em.wsu.edu/css/SpinePad1.css' because its MIME type ('') is not a supported stylesheet MIME type, and strict MIME checking is enabled.
Refused to apply style from 'https://ro411.em.wsu.edu/css/SpinePad1.css' because its MIME type ('') is not a supported stylesheet MIME type, and strict MIME checking is enabled.
