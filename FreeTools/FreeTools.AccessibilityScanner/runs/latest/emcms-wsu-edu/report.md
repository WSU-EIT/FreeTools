# 🌐 Site Report: https://emcms.wsu.edu/

> **Status:** ⚠️ 0/1 pages OK  
> **Folder:** `emcms-wsu-edu/`  
...
```
Refused to apply style from 'https://emcms.wsu.edu/css/SpinePad1.css' because its MIME type ('') is not a supported stylesheet MIME type, and strict MIME checking is enabled.
Refused to apply style from 'https://emcms.wsu.edu/css/SpinePad1.css' because its MIME type ('') is not a supported stylesheet MIME type, and strict MIME checking is enabled.
