...
> **URL:** https://hrs.wsu.edu/contact/es-service-teams/  
...
|-------|-------|
| URL | https://hrs.wsu.edu/contact/es-service-teams/ |
| Title | HR Service Teams – Human Resource Services, Washington State University |
| Status | ✅ 200 |
| HTML Size | 86.0 KB |
| Screenshots | 1 (341.5 KB) |
| Images | 0 (referenced by URL) |
| Images Missing Alt | ✅ 0 |
| JS Errors | 🔴 2 |
| JS Warnings | 1 |
| A11y Violations | ⚠️ 38 |
| 🔴 Critical | 0 |
| 🟠 Serious | 37 |
| 🟡 Moderate | 1 |
| 🔵 Minor | 0 |
...
| Auth | none |
| Captured | 2026-02-19T02:09:10.4005513Z |
...
- Screenshot #1: page-loaded (341.5 KB)
- No images found on page
- axe-core: 16 violations (316ms)
- htmlcheck: 22 violations (1ms)
...
|--:|------|:---:|:----------:|:---:|:---:|---------|
| 1 | [link-name](../../a11y-rules.md#link-name) | 🟠 | 🟢 2/2 | ⚠️ | ⚠️ | `<a href="mailto:larkin.mott@wsu.edu" target="_blank" rel=...` |
...
| 4 | [heading-order](../../a11y-rules.md#heading-order) | 🟡 | 🟡 1/2 | ✅ | ⚠️ | `<h3 class="wp-block-heading">` |
...
| File | Description |
|------|-------------|
| `01-page-loaded.jpg` | page-loaded (341.5 KB) |
