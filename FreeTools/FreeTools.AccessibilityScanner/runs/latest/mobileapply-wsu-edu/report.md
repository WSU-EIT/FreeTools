# 🌐 Site Report: https://mobileapply.wsu.edu/

> **Status:** ⚠️ 0/1 pages OK  
> **Folder:** `mobileapply-wsu-edu/`  
...
|:------:|------|:----:|-------|:--:|:--:|:--:|:--:|:----:|
| ❌ | [/](_root/report.md) | 0 | Enrollment Management | 1 |  |  |  | ⚠️ 1 |
...
<details>
<summary><strong>4 error(s) across 1 page(s)</strong></summary>

**/** (4 errors)

```
Access to XMLHttpRequest at 'https://api.oneorigin.us/p-cs/ref?required=y' from origin 'http://em.wsu.edu' has been blocked by CORS policy: No 'Access-Control-Allow-Origin' header is present on the re...
Failed to load resource: net::ERR_FAILED
Access to XMLHttpRequest at 'https://searchassets.oneorigin.us/p-ss/2.6.0/search-bundle.min.css' from origin 'http://em.wsu.edu' has been blocked by CORS policy: No 'Access-Control-Allow-Origin' heade...
Failed to load resource: net::ERR_FAILED
```
