...
|------|:---:|:----:|:-----:|:---------:|-------------|
| [link-name](#link-name) | 🟠 | 2.4.4 | ⚠️ 120 pg | 480 | Links must have discernible text |
| [landmark-one-main](#landmark-one-main) | 🟡 | 1.3.1 | ⚠️ 120 pg | 120 | Page should have one main landmark |
| [page-has-heading-one](#page-has-heading-one) | 🟡 | 1.3.1 | ⚠️ 2 pg | 2 | Page should contain a level-one heading |
| [skip-link](#skip-link) | 🟡 | 2.4.1 | ⚠️ 120 pg | 120 | Page should have a skip navigation link |
...
| [color-contrast](#color-contrast) | 🟠 | 1.4.3 | — | — | Elements must have sufficient color contrast |
| [document-title](#document-title) | 🟠 | 2.4.2 | — | — | Document must have a title |
...
| [image-alt](#image-alt) | 🟠 | 1.1.1 | — | — | Images must have alternate text |
...
| [landmark-nav](#landmark-nav) | 🔵 | 1.3.1 | — | — | Page should have a navigation landmark |
...
```html
<a class="nav-link dropdown-toggle" href="#" id="themeDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"><!--!--><i class="icon i...
```
...
| Status in scan | ✅ Not detected |
| Learn more | [https://dequeuniversity.com/rules/axe/4.10/color-contrast](https://dequeuniversity.com/rules/axe/4.10/color-contrast) |
...
| Status in scan | ✅ Not detected |
| Learn more | [https://dequeuniversity.com/rules/axe/4.10/document-title](https://dequeuniversity.com/rules/axe/4.10/document-title) |
