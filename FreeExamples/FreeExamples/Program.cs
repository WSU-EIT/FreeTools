...
namespace FreeExamples
{
    public partial class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(FreeExamples.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(FreeExamples.Client.BlazorDataModel).Assembly.Location); } catch { }
            ...
            app.MapHub<freeexamplesHub>("/freeexamplesHub", signalRConnctionOptions => {
